...
namespace ToDoAPI.DAL
{
    public static class ModelBuilderExtensions
    {
        ...
        {
            modelBuilder.Entity<Users>().HasData(new Users { UserId = 101, UserName = "Admin", Password = Cryptography.Encrypt("Pa$$w0rd") });
            modelBuilder.Entity<Users>().HasData(new Users { UserId = 102, UserName = "Standard", Password = Cryptography.Encrypt("Pa$$w0rd2") });
